...
Partial Class AcercadeCostoMinimo
    ...
    Private Sub InitializeComponent()
        ...
        Me.ListBox1.Items.AddRange(New Object() {"Este es un programa para resolver", "problemas de transporte de Investigación", "de Operaciones con el Método de ", "Costo Mínimo."})
        ...
        Me.Label3.Text = "Método de Costo Mínimo"
        '
        'AcercadeCostoMinimo
        '
