...
Partial Class AcercadeMetodosdeTransporte
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label3.Text = "Método de Transporte en Investigacion de Operaciones"
        '
        'btnok
        '
        ...
        Me.ListBox1.Items.AddRange(New Object() {"Este es un programa deseñado para resolver problemas ", "de transporte de Investigaciónde Operaciones con ", "los Métodos siguientes:", "*Método de Esquina Nor-Oeste", "*Método de Costo Mínimo", "*Método de Voguel", "*Método de Russell"})
